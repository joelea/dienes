...
/***/ function(module, exports, __webpack_require__) {
	...
	var Bacon, attach, createElement, decompose, decomposition, diene, h, hundreds, hundredsDom, hundredsInput, initialDom, inputsTo, number, ones, onesDom, onesInput, recompose, renderAs, safeParseInt, setNumberInput, subDecomposition, tens, tensDom, tensInput;

	attach = __webpack_require__(1);

	Bacon = __webpack_require__(25);

	h = __webpack_require__(29).h;

	createElement = __webpack_require__(29).create;

	decompose = __webpack_require__(41);

	recompose = __webpack_require__(43);

	renderAs = __webpack_require__(44);

	initialDom = __webpack_require__(49);

	safeParseInt = __webpack_require__(50);

	diene = __webpack_require__(51);

	document.getElementById('app').appendChild(createElement(initialDom()));

	setNumberInput = document.getElementById('set-number');

	inputsTo = function(input) {
	  return Bacon.fromEvent(input, 'input', function(event) {
	    return event.target.value;
	  }).startWith(input.value).map(safeParseInt);
	};
	...
	subDecomposition = Bacon.mergeAll(inputsTo(onesInput), inputsTo(tensInput), inputsTo(hundredsInput)).map(function() {
	  return {
	...
	decomposition = Bacon.mergeAll(number.map(decompose), subDecomposition);

	decomposition.onValue(function(decomp) {
	  var ref, ref1, ref2;
	  setNumberInput.value = recompose(decomp);
	  onesInput.value = (ref = decomp.ones) != null ? ref : 0;
	  tensInput.value = (ref1 = decomp.tens) != null ? ref1 : 0;
	  return hundredsInput.value = (ref2 = decomp.hundreds) != null ? ref2 : 0;
	});
	    ...
	    return {
	        to: function (parentElement) {
	            var initialNode = vtreeStream
	                ...
	                .map(createElement)
	                .toProperty();
	            initialNode.onValue(function (rootNode) { parentElement.appendChild(rootNode); });
	            vtreeStream
	                .slidingWindow(2, 2)
	                .map(function (trees) { return diff(trees[0], trees[1]); })
	                .combine(initialNode, function (patches, rootNode) {
	                return {
	                    patches: patches,
	                    rootNode: rootNode
	                };
	            }).onValue(function (frame) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("function" !== "undefined" && __webpack_require__(27) !== null && __webpack_require__(28) != null) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var evHook = __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EvStore = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OneVersionConstraint = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _, decompose, inputErrors, recurse, validityChecks;
	...
	validityChecks = [
	  function(raw) {
	    if (raw.match(/[^\d]/)) {
	      return "Sorry, " + raw + " is not a number";
	    }
	  }, function(raw) {
	    if (raw.length > 3) {
	      return 'Sorry, we can only deal with up to 4-digit numbers';
	    }
	  }
	];

	inputErrors = function(rawNumber) {
	  return validityChecks.map(function(check) {
	    return check(rawNumber);
	  });
	};

	recurse = function(n, columns) {
	  var lastDigit, thisColumn, thisColumnName;
	  ...
	  thisColumn = {};
	  if (lastDigit > 0) {
	    thisColumn[thisColumnName] = lastDigit;
	  }
	  return _.assign(thisColumn, recurse(Math.floor(n / 10), columns));
	};

	decompose = function(inputNumber) {
	  var errors, number, rawNumber;
	  rawNumber = String(inputNumber);
	  errors = inputErrors(rawNumber).filter(function(error) {
	    return error != null;
	  });
	  if (!_(errors).isEmpty()) {
	    return {
...
/***/ function(module, exports) {
	...
	module.exports = function(arg) {
	  var errors, hundreds, ones, tens;
	  ones = arg.ones, tens = arg.tens, hundreds = arg.hundreds, errors = arg.errors;
	  if (errors != null) {
	    throw Error(errors);
	  }
	  return 1 * (ones != null ? ones : 0) + 10 * (tens != null ? tens : 0) + 100 * (hundreds != null ? hundreds : 0);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(contents, selectors) {
	  return function(count) {
	    return h(selectors, _.range(count).map(function() {
	      return contents;
	    }));
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n  font-size: 35px;\n}\n.page-header {\n  text-align: center;\n  width: 100%;\n  height: 10vh;\n}\n.page-header #set-number {\n  font-size: 35px;\n  border-radius: 4px;\n  border: 1px solid black;\n  box-shadow: none;\n  text-align: center;\n}\n.columns {\n  display: flex;\n}\n.columns .column {\n  height: 100%;\n  width: 33%;\n  overflow: auto;\n  display: flex;\n  flex-flow: column;\n  border-collapse: collapse;\n}\n.columns .column .column-header {\n  border: 1px solid black;\n  border-collapse: collapse;\n  text-align: center;\n  height: 100%;\n}\n.columns .column .column-header * {\n  margin: 0;\n  padding: 0;\n  border-collapse: collapse;\n}\n.columns .column .column-body {\n  height: 75vh;\n  border: 1px solid black;\n  border-bottom: none;\n  border-collapse: collapse;\n}\n.columns .column .column-body > * {\n  display: flex;\n  flex-wrap: wrap;\n}\n.columns .column .column-body > * .diene {\n  background-color: cadetblue;\n  border: 1px solid white;\n  margin: 10px;\n  border-collapse: collapse;\n}\n.columns .column .column-body > * .diene td {\n  width: 12px;\n  height: 12px;\n  padding: 0px;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var body, column, h, header;

	__webpack_require__(45);

	h = __webpack_require__(29).h;

	header = function(columnName) {
	  return h(".column-header", [h("h4", columnName), h("input\#" + columnName + "-input", [])]);
	};

	body = function(columnName) {
	  return h('.column-body#' + columnName + '-anchor');
	};

	column = function(columnName) {
	  return h(".column.column-" + columnName, [header(columnName), body(columnName)]);
	};

	module.exports = function() {
	  return h('.contents', [h('.columns', [column('hundreds'), column('tens'), column('ones')])]);
	};
...
/***/ function(module, exports) {
	...
	module.exports = function(rawNumber) {
	  var number;
	  number = Number.parseInt(rawNumber);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _, diene, h, rowContents, rows;

	h = __webpack_require__(29).h;

	_ = __webpack_require__(42);

	rowContents = function(n) {
	  return _.range(n).map(function() {
	    return h('td');
	  });
	};

	rows = function(n, contents) {
	  return _.range(n).map(function() {
	    return h('tr', contents);
	  });
	};

	diene = function(name, x, y) {
	  return h("table." + name + ".diene", rows(x, rowContents(y)));
	};

	module.exports = {
	  one: function() {
	    return diene('one', 1, 1);
	  },
	  ten: function() {
	    return diene('ten', 10, 1);
	  },
	  hundred: function() {
	    return diene('hundred', 10, 10);
	  }
	};
